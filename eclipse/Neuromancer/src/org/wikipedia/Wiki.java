...
public class Wiki implements Serializable
{
    ...
    public String getSectionText(String title, int number) throws IOException
    {
        ...
        String finalText = decode(text.substring(a, b));
        if(!finalText.toUpperCase().contains("REDIRECT"))
        {
        	return finalText;
        }else
        {
        	return getSectionText(finalText.substring(finalText.indexOf("[[")+2, finalText.indexOf("]]")), number);
        }
    }
